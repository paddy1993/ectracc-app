...
// Navigation item type (Note: React.ComponentType is platform-specific, so we use any here)
export interface NavItem {
  path: string;
  label: string;
  icon: any; // Platform-specific icon component
}

// PWA install prompt (Web-specific, but kept here for compatibility)
...
export interface NotificationService {
  requestPermissions(): Promise<boolean>;
  scheduleNotification(title: string, body: string, trigger?: any): Promise<string>;
